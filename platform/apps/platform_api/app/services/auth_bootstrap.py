...
from python_packages.platform_infra.performance import measure_auth_bootstrap_stage
...
async def build_auth_bootstrap(
    ...
    *,
    ...
    if db_session is None:
        ...
        with measure_auth_bootstrap_stage("auth_bootstrap_avatar_query"):
    ...
    with measure_auth_bootstrap_stage("auth_bootstrap_response_build"):
