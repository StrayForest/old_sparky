...
WORKER_KEYS = frozenset({
    ...
    "PLATFORM_DB_CONNECTION_BUDGET",
    "PLATFORM_WORKER_DB_POOL_SIZE",
    "PLATFORM_WORKER_DB_MAX_OVERFLOW",
    "PLATFORM_WORKER_DB_POOL_TIMEOUT_SECONDS",
    "PLATFORM_WORKER_DB_POOL_RECYCLE_SECONDS",
