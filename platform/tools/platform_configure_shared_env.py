...
PUBLIC_BASELINE = {
    ...
    "PLATFORM_GUNICORN_ACCESS_LOG": "false",
    "PLATFORM_WORKER_LOG_LEVEL": "WARNING",
    ...
    "PLATFORM_READY_VOTE_ADMISSION_RECOVERY_SAMPLES": "8",
    "PLATFORM_READY_VOTE_ADMISSION_CONTROL_INTERVAL_SECONDS": "0.5",
    "PLATFORM_DB_POOL_SIZE": "24",
    ...
    "PLATFORM_PERF_LOG_SAMPLE_RATE": "0.25",
